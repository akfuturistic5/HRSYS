  ...
  >
    ...
    <div class="offcanvas-footer border-top p-3 text-center">
      <div class="row">
        ...
        <div class="col-6">
          <a
            href="https://themeforest.net/item/smarthr-admin-dashboard-html-template/29466146?s_rank=2"
            target="_blank"
      ...
      function t() {
        ...
        b &&
          ...
          ((c = document.createElement("ul")).innerHTML =
            '<a href="javascript:;" class="logo"><img src="assets/img/logo.png" alt="User Image" height="22"></a>'),
          Array.from(
          ...
          Array.from(
            ...
            a.addEventListener("click", function (c) {
              var d;
              (b != "/" + a.getAttribute("href") || a.getAttribute("data-bs-toggle")) &&
                ...
                ((c.target && c.target.matches("a.nav-icon")) ||
                  ...
                  0 <
                    (d = document.getElementsByClassName("twocolumn-item-show")).length &&
                    d[0].classList.remove("twocolumn-item-show"),
